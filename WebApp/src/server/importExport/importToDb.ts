...
async function validatePlayerChanges(
    ...
    const oldestPointImport = (getOldest(pointHistory) - 1) * 1000; // Addon is seconds timestamps, -1s to make sure we always get the entry from DB even considering rounding.
