...
export abstract class BotCommandBase {
     ...
     */
    protected setRequiresPermission(): void {
     ...
     */
    protected addStringOption(name: string, description: string, minLen = 0, maxLen = 9999): void {
     ...
     */
    getPayload(): RESTPostAPIChatInputApplicationCommandsJSONBody {
     ...
     * @returns
     */
    protected replyError(interaction: ChatInputCommandInteraction, msg: string): Promise<boolean> {
     ...
     * @returns
     */
    protected replySuccess(interaction: ChatInputCommandInteraction, msg: string): Promise<boolean> {
        return this.interactionReply(interaction, "🐻 " + msg);
    }
     ...
     * @returns
     */
    protected getInteractionVoicechannel(interaction: ChatInputCommandInteraction): VoiceBasedChannel | null {
